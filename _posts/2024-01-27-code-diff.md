...
But this is difficult to read, specially if you have a large diff. You can use [Broken Link] to display a more readable version of the diff. For this, just use `diff2html` instead of `diff` for the code block language:
